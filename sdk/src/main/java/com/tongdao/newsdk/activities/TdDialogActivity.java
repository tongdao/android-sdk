package com.tongdao.newsdk.activities;
...
import com.tongdao.newsdk.tools.TdDisplayTool;
import com.tongdao.newsdk.tools.TdImageManager;
import com.tongdao.newsdk.tools.TdUtils;
import com.tongdao.newsdk.ui.TdFragmentPagerAdapter;
import com.tongdao.newsdk.ui.TdPageFragment;
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        if (!TdDialogActivity.this.isFinishing()) {
                            ...
                            if (pageBean != null && pageBean.getRewardList() != null && TongDao.getRewardUnlockedListener() != null) {
                                TongDao.getRewardUnlockedListener().onSuccess(pageBean.getRewardList());
                            }
